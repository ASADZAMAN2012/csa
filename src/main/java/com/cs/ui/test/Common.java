...
public class Common extends BaseTest
{
	...
	public void billingInfoExistingCustomerWithSameAddress() throws Exception
	{
		try 
		{
			driver.findElement(By.name("bill_firstname")).clear();
		...
		try 
		{
			driver.findElement(By.name("bill_lastname")).clear();
		...
		try 
		{
			driver.findElement(By.name("bill_addressline1")).clear();
		...
		try 
		{
			driver.findElement(By.name("bill_towncity")).clear();
		...
		try 
		{
			driver.findElement(By.name("bill_countystate")).clear();
		...
		try 
		{
			driver.findElement(By.name("bill_postzip")).clear();
	...
	public void billingInfoExistingCustomerWithDifferentAddress() throws Exception
	{
		...
		{
			System.out.println("Billing same as checkbox not found");
		}
		
		try 
		{
			driver.findElement(By.name("ship_addressline1")).clear();
		...
		try 
		{
			driver.findElement(By.name("ship_towncity")).clear();
		...
		try 
		{
			driver.findElement(By.name("ship_countystate")).clear();
		...
		try 
		{
			driver.findElement(By.name("ship_postzip")).clear();
